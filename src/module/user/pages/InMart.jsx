...
// Using placeholders for in-mart card images
const inMartCard1 = "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=300&fit=crop"
const inMartCard2 = "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=300&fit=crop"
const inMartCard3 = "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=300&fit=crop"
const inMartCard4 = "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=300&fit=crop"
const inMartCard5 = "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=300&fit=crop"
const inMartCard6 = "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=300&fit=crop"

// Using placeholder for in-mart banner
...
const MOCK_CATEGORIES = inMartCategories
    ...
    const fetchInMartHeroBanner = async () => {
      try {
        ...
        if (response.data.success && response.data.data.banners && response.data.data.banners.length > 0) {
          ...
          setInMartHeroBanner(inMartBanner)
        }
      } catch (error) {
  ...
  return (
    <AnimatedPage className="bg-white dark:bg-[#0a0a0a]" style={{ minHeight: '100vh', paddingBottom: '80px', overflow: 'visible' }}>
      ...
      <div
        ...
        onClick={() => navigate('/user/in-mart/restaurants')}
      >
        {/* Background with in-mart banner */}
        <div className="absolute top-0 left-0 right-0 bottom-0 z-0">
          {inMartHeroBanner && (
            <OptimizedImage
              src={inMartHeroBanner}
              alt="In Mart Banner"
            ...
            <div className="grid grid-cols-3 sm:grid-cols-3 md:grid-cols-6 gap-3 sm:gap-4">
              {categories.map((category, index) => (
                <Link
                  ...
                  to={`/user/in-mart/${category.name.toLowerCase().replace(/\s+/g, '-')}`}
                >
                  <motion.div
